namespace BakupsDeVitalDent
{
	partial class frmHistorialMedico
	{
		...
		private void InitializeComponent()
		{
			...
			lblHistorialMedico.Location = new Point(12, 9);
			lblHistorialMedico.Name = "lblHistorialMedico";
			lblHistorialMedico.Size = new Size(175, 30);
			...
			ptbLupa.Location = new Point(148, 54);
			ptbLupa.Name = "ptbLupa";
			ptbLupa.Size = new Size(24, 25);
			...
			btnBuscar.Location = new Point(901, 49);
			...
			txtBuscarPaciente.Location = new Point(178, 54);
			...
			txtBuscarPaciente.Size = new Size(717, 25);
			...
			lblNombre.Location = new Point(83, 113);
			...
			// txtNombre
			// 
			txtNombre.Location = new Point(227, 113);
			...
			lblDiagnostico.Location = new Point(83, 235);
			...
			// txtDiagnostico
			// 
			txtDiagnostico.Location = new Point(227, 235);
			txtDiagnostico.Multiline = true;
			txtDiagnostico.Name = "txtDiagnostico";
			txtDiagnostico.Size = new Size(717, 20);
			...
			lblMedicameto.Location = new Point(83, 312);
			lblMedicameto.Name = "lblMedicameto";
			lblMedicameto.Size = new Size(101, 20);
